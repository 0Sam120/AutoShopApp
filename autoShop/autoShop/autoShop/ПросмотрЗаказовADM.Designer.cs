namespace autoShop
{
    partial class ПросмотрЗаказовADM
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "ПросмотрЗаказовADM";
            this.Text = "ПросмотрЗаказовADM";
            this.Load += new System.EventHandler(this.ПросмотрЗаказовADM_Load);
